...
import de.htwg.se.TradingGame.model.GetMarketDataComponent.PrintMarketData
...
class BacktestInterpreter @Inject() (val gameStateManager: GameStateManager) extends Interpreter {
